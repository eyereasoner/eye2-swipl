...
%% 'https://eyereasoner.github.io/etc#determinant'(+A, -D) is det.
% computes the determinant for a positive semi-definite matrix.
% Uses the Cholenski decomposition
% ==
% ?- 'https://eyereasoner.github.io/etc#determinant'([[2, -1, 0], [-1, 2, -1], [0, -1, 2]], D).
% D = 3.999999999999999.
% ==
'https://eyereasoner.github.io/etc#determinant'(A, Det) :-
    'https://eyereasoner.github.io/etc#cholesky_decomposition'(A, L),
    get_diagonal(L, D),
    foldl(prod, D, 1, DetL),
    Det is DetL*DetL.
...
%% 'https://eyereasoner.github.io/etc#matrix_inversion'(+M, -IM) is det.
% inversion of a positive semi-definite matrix. Uses the Cholenski
% decomposition
% ==
% ?- 'https://eyereasoner.github.io/etc#matrix_inversion'([[2, -1, 0], [-1, 2, -1], [0, -1, 2]], L).
...
% ==
'https://eyereasoner.github.io/etc#matrix_inversion'(A, B) :-
    'https://eyereasoner.github.io/etc#cholesky_decomposition'(A, L),
    'https://eyereasoner.github.io/etc#matrix_inv_triang'(L, LI),
    transpose_local(LI, LIT),
    'https://eyereasoner.github.io/etc#matrix_multiply'([LIT, LI], B).

%% 'https://eyereasoner.github.io/etc#matrix_inv_triang'(+M, -IM) is det.
...
% code from
% ==
% ?- 'https://eyereasoner.github.io/etc#matrix_inv_triang'([[2, 0, 0], [-1, 2, 0], [0, -1, 2]], L).
% L = [[0.5, 0.0, 0.0], [0.25, 0.5, 0.0], [0.125, 0.25, 0.5]].
% ==
'https://eyereasoner.github.io/etc#matrix_inv_triang'(L1, L2) :-
    get_diagonal(L1, D),
    maplist(inv, D, ID),
    length(ID, N),
    NN is N*N,
    ...
    'https://eyereasoner.github.io/etc#matrix_multiply'([IDM, L1], LL1),
    append(LL1, LT),
    length(LL1, N),
    matrix_inv_i(1, N, LT, LTT),
    identify_rows(LTT, N, LL2),
    'https://eyereasoner.github.io/etc#matrix_multiply'([LL2, IDM], L2).
...
%% 'https://eyereasoner.github.io/etc#matrix_multiply'([+X, +Y], -M) is det.
%
%   X(N*P), Y(P*M), M(N*M)
% ==
% ?- 'https://eyereasoner.github.io/etc#matrix_multiply'([[[1, 2], [3, 4], [5, 6]], [[1, 1, 1], [1, 1, 1]]], R).
% R = [[3, 3, 3], [7, 7, 7], [11, 11, 11]].
% ==
% code from http://stackoverflow.com/questions/34206275/matrix-multiplication-with-prolog
'https://eyereasoner.github.io/etc#matrix_multiply'([X, Y], M) :-
    matrix_mul(X, Y, M0),
...
%% 'https://eyereasoner.github.io/etc#matrix_sum'([+A, +B], -C) is det
% ==
% ?- 'https://eyereasoner.github.io/etc#matrix_sum'([[[1, 2], [3, 4], [5, 6]], [[1, 2], [3, 4], [5, 6]]], M).
% ==
'https://eyereasoner.github.io/etc#matrix_sum'([X, Y], S) :-
    maplist(maplist(sum), X, Y, S).

sum(A, B, C) :-
    C is A+B.

%% 'https://eyereasoner.github.io/etc#cholesky_decomposition'(+A, -L) is det.
...
% ==
% ?- 'https://eyereasoner.github.io/etc#cholesky_decomposition'([[25, 15, -5], [15, 18, 0], [-5, 0, 11]], L).
% L = [[5.0, 0, 0], [3.0, 3.0, 0], [-1.0, 1.0, 3.0]].
% ?- 'https://eyereasoner.github.io/etc#cholesky_decomposition'([[18, 22, 54, 42], [22, 70, 86, 62], [54, 86, 174, 134], [42, 62, 134, 106]], L).
...
% query
'https://eyereasoner.github.io/etc#determinant'([[2, -1, 0], [-1, 2, -1], [0, -1, 2]], _ANSWER) :+ true.
'https://eyereasoner.github.io/etc#matrix_inversion'([[2, -1, 0], [-1, 2, -1], [0, -1, 2]], _ANSWER) :+ true.
'https://eyereasoner.github.io/etc#matrix_inversion'([[18, 22, 54, 42], [22, 70, 86, 62], [54, 86, 174, 134], [42, 62, 134, 106]], _ANSWER) :+ true.
'https://eyereasoner.github.io/etc#matrix_inv_triang'([[2, 0, 0], [-1, 2, 0], [0, -1, 2]], _ANSWER) :+ true.
'https://eyereasoner.github.io/etc#matrix_multiply'([[[1, 2], [3, 4], [5, 6]], [[1, 1, 1], [1, 1, 1]]], _ANSWER) :+ true.
'https://eyereasoner.github.io/etc#matrix_multiply'([[[18, 22, 54, 42], [22, 70, 86, 62], [54, 86, 174, 134], [42, 62, 134, 106]], [[2.515624999999984, 0.4843749999999933, -1.296874999999973, 0.3593749999999767], [0.4843749999999933, 0.1406249999999978, -0.3281249999999918, 0.1406249999999936], [-1.296874999999973, -0.3281249999999918, 1.015624999999971, -0.5781249999999781], [0.3593749999999767, 0.1406249999999936, -0.5781249999999781, 0.5156249999999853]]], _ANSWER) :+ true.
'https://eyereasoner.github.io/etc#matrix_sum'([[[1, 2], [3, 4], [5, 6]], [[1, 2], [3, 4], [5, 6]]], _ANSWER) :+ true.
'https://eyereasoner.github.io/etc#cholesky_decomposition'([[25, 15, -5], [15, 18, 0], [-5, 0, 11]], _ANSWER) :+ true.
'https://eyereasoner.github.io/etc#cholesky_decomposition'([[18, 22, 54, 42], [22, 70, 86, 62], [54, 86, 174, 134], [42, 62, 134, 106]], _ANSWER) :+ true.
